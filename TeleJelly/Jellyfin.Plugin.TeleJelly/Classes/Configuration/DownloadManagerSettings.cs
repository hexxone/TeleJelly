...
namespace Jellyfin.Plugin.TeleJelly.Classes.Configuration
{
    public class DownloadManagerSettings
    {
        ...
        public List<string> WhitelistUsernames { get; set; } = new();
    ...
    {
        public bool Enabled { get; set; } = true;
        public List<string> Passwords { get; set; } = new() { "password", "123456" };
    ...
    public class LibrarySettings
    {
        ...
        public List<DynamicPathVariable> DynamicVariables { get; set; } = new();
    ...
    public class QualityProfile
    {
        ...
        public Dictionary<string, long> MaxFileSizeByResolution { get; set; } = new()
        {
            { "2160p", 50L * 1024 * 1024 * 1024 },
            { "1080p", 20L * 1024 * 1024 * 1024 },
            { "720p", 10L * 1024 * 1024 * 1024 }
        };
        public Dictionary<string, long> MinFileSizeByResolution { get; set; } = new()
        {
            { "2160p", 15L * 1024 * 1024 * 1024 },
            { "1080p", 5L * 1024 * 1024 * 1024 },
            { "720p", 2L * 1024 * 1024 * 1024 }
        };
